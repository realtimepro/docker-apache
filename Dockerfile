...
RUN apt-get update && \
    ...
    apache2 php7.0-common && \
    apt-get install -y --force-yes \
    libapache2-mod-php7.0 php7.0-cgi php7.0-cli php7.0-phpdbg libphp7.0-embed php7.0-dev \
    ...
    php7.0-sqlite3 php7.0-mysql php7.0-opcache php7.0-bz2 php7.0-mbstring && \
    a2enmod rewrite && \
    a2enmod headers && \
    apt-get clean && \
    apt-get autoclean && \
